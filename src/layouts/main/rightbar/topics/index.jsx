...
export default function Topics() {
  return (
    <div className="bg-[#16181c] rounded-2xl mb-4">
      <h2 className="text-extraLight-gray font-extrabold leading-6 text-[1.25rem] py-3 px-4">
      ...
      {topics.map((topic, index) => (
        ...
        >
          <div className="flex flex-col">
            ...
            <div className="mt-0.5 font-bold text-[0.938rem] leading-5 text-[#e7e9ea] flex items-center">
          ...
          <Popover className="relative">
            ...
            <Popover.Panel className="absolute z-10 bg-black shadow-moreBox w-[23.813rem] rounded-xl right-0 top-0">
              <button className="hover:bg-[#ffffff08] w-full flex items-center py-3 px-4">
                ...
                <span className="font-bold text-[0.938rem] leading-5 text-[#e7e9ea]">
                  İlgimi çekmiyor
                </span>
              </button>
              <button className="hover:bg-[#ffffff08] w-full flex items-center py-3 px-4">
