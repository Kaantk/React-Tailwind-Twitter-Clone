    ...
    <Popover className="relative">
      <Popover.Button className="flex group py-1 outline-none">
        <div className="inline-flex p-3 group-hover:bg-[#e7e9ea1a] rounded-full">
          ...
          <span className="inline-block ml-5 mr-4 leading-6 text-[1.25rem] text-extraLight-gray font-normal">
            Daha fazla
          </span>
        </div>
      </Popover.Button>
      ...
      <Popover.Panel
        role="menu"
        className="absolute -top-[240px] z-10 text-white bg-black flex flex-col min-w-[19.875rem] shadow-moreBox rounded-xl overflow-hidden"
      >
        <div className="flex p-4 items-center font-bold hover:bg-[#16181c] cursor-pointer transition-colors">
          ...
          <span className="text-extraLight-gray text-[1.25rem]">Bağlan</span>
        </div>
        <div className="flex p-4 items-center font-bold hover:bg-[#16181c] cursor-pointer transition-colors">
          <svg viewBox="0 0 24 24" width={24} height={24} className="mr-6">
            <path
          ...
          <span className="text-extraLight-gray text-[1.25rem]">
            Para kazanma
          </span>
        </div>
        ...
        <div
          role="seperator"
          className="h-px bg-[#2f3336] w-[90%] mx-auto my-0.5"
        />

        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="w-full flex items-center justify-between p-4 hover:bg-[#16181c] cursor-pointer transition-colors">
                <span className="text-[0.938rem] font-bold text-extraLight-gray">
              ...
              <Disclosure.Panel>
                <div className="p-3 flex items-center hover:bg-[#16181c] cursor-pointer transition-colors">
                  <svg
                    viewBox="0 0 24 24"
                    width={18.75}
                    height={18.75}
                  ...
                  <span className="text-[0.938rem] font-semibold text-extraLight-gray">
                    İstatistikler
                  </span>
                </div>
              </Disclosure.Panel>
