    ...
    <Popover className="relative text-[--color-base]">
      <Popover.Button className="flex group py-1 outline-none">
        <div className="inline-flex p-3 group-hover:bg-[color:var(--background-hover)] rounded-full">
          ...
          <span className="inline-block ml-5 mr-4 leading-6 text-[1.25rem] font-normal">
            Daha fazla
          </span>
        </div>
      </Popover.Button>
      ...
      <Popover.Panel
        role="menu"
        className="absolute -top-[240px] z-10 text-[--color-base] bg-[color:var(--background-primary)] flex flex-col min-w-[19.875rem] shadow-box rounded-xl overflow-hidden"
      >
        <div className="flex p-4 items-center font-bold hover:bg-[color:var(--background-secondary)] cursor-pointer transition-colors">
          ...
          <span className="text-[color:var(--color-base)] text-[1.25rem]">
            Bağlan
          </span>
        </div>
        <div className="flex p-4 items-center font-bold hover:bg-[color:var(--background-secondary)] cursor-pointer transition-colors">
        ...
        <div
          role="seperator"
          className="h-px bg-[color:var(--background-third)] w-[90%] mx-auto my-0.5"
        />

        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="w-full flex items-center justify-between p-4 hover:bg-[color:var(--background-secondary)] cursor-pointer transition-colors">
                <span className="text-[0.938rem] font-bold text-[color:var(--color-base)]">
                ...
                <svg
                  ...
                  width={18.75}
                  height={18.75}
                  className={classNames({ "rotate-180 transition-all": open })}
                >
                  <path
                    fill={open ? "#1d9bf0" : "currentColor"}
                    d="M3.543 8.96l1.414-1.42L12 14.59l7.043-7.05 1.414 1.42L12 17.41 3.543 8.96z"
                  />
                </svg>
              </Disclosure.Button>
              <Disclosure.Panel className="text-[--color-base]">
                <div className="p-3 flex items-center hover:bg-[color:var(--background-secondary)] cursor-pointer transition-colors">
                  <svg
                    viewBox="0 0 24 24"
                    width={18.75}
                    height={18.75}
                  ...
                  <span className="text-[0.938rem] font-semibold text-[color:var(--color-base)]">
                    İstatistikler
                  </span>
                </div>
              </Disclosure.Panel>
          ...
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel>
                ...
                <button
                  className="p-3 flex items-center hover:bg-[color:var(--background-secondary)] cursor-pointer w-full transition-colors"
                  onClick={() => setModal("appearance", true)}
                >
                  <svg
                    viewBox="0 0 24 24"
                    width={18.75}
